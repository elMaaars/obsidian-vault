...
- Una forma de decidir cuál parcelación subcortical acoplar a la parcelación cortical es revisar el tamaño promedio de las parcelas para intentar obtener una parcelación de tamaño similar.
...
- Con estas nuevas etiquetas y las señales BOLD se aplica nuevamente `wb_command` para generar las matrices de conectividad funcional.